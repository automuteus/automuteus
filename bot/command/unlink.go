...
func UnlinkResponse(status amongus.UnlinkStatus, userID string, sett *settings.GuildSettings) *discordgo.InteractionResponse {
	var content string
	switch status {
	case amongus.UnlinkSuccess:
